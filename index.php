...
<head>
    ...
    <title>Privacy faq lookalike</title>
...
<body>
    <header>
        <div class="header_top">
            <div class="logo">
                <img src="img\Google_2015_logo.svg.png" alt="logo di google">
            </div>
            <div class="title">Privacy&Termini</div>
        </div>
    ...
    <main>
        <div class="container">
            <?php foreach($faq as $policyText) {?>
                <div class="container">
                <div class="main_content">
                <h2><?php echo $policyText['question']; ?></h2>
                <p><?php echo $policyText['answer']; ?></p>
                </div>
                </div>
                <?php } ?>
        </div>
